    ...
    <div style={{ display: 'flex', height: '100vh', background: 'var(--bg)', overflow: 'hidden' }}>
      ...
      <div className="sidebar" style={{ width: 200, display: 'flex', flexDirection: 'column', flexShrink: 0, height: '100vh' }}>
        ...
        <div style={{ padding: '14px 14px 12px', borderBottom: '1.5px solid var(--bd)', display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 32, height: 32, background: 'var(--lm)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: 'var(--ld)', fontSize: 15, flexShrink: 0 }}>P</div>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: 'var(--tx)', letterSpacing: 0.5 }}>PRO IT</div>
        ...
        <div style={{ padding: '8px 6px', borderTop: '1.5px solid var(--bd)' }}>
          ...
          <div onClick={toggleTheme} style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '6px 10px', borderRadius: 7, cursor: 'pointer', fontSize: 11, color: 'var(--mt)' }}>
            {theme === 'dark' ? '☀️ Tema e Bardhe' : '🌙 Tema e Zeze'}
          </div>
          <div onClick={onLogout}
            style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '6px 10px', borderRadius: 7, cursor: 'pointer', fontSize: 12, color: 'var(--rd)' }}>
            🚪 Dil
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
        ...
        <div style={{ borderTop: '1.5px solid var(--bd)', padding: '6px 20px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: 'var(--bg2)' }}>
          <div style={{ width: 18, height: 18, background: 'var(--lm)', borderRadius: 4, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: 'var(--ld)', fontSize: 10 }}>P</div>
